...
dictionary <- tribble(
  ...
  "`eviction_filings`", "Number of eviction court cases filed", "Eviction Lab", "Census Tract", "coc_evictions",
  "`evictions`", "Number of evictions", "Eviction Lab", "Census Tract", "coc_evictions",
  "`eviction_filing_rate`", "Eviction court cases / renting households", "Eviction Lab", "Census Tract", "coc_evictions",
  "`eviction_rate`", "Evictions / renting households", "Eviction Lab", "Census Tract", "coc_evictions"
)
```
